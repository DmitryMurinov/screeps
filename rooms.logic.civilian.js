        ...
        if (freeSpawn != undefined) {
            if (controllerLevel < 3 || creepPotential < 800 || localMadeCreeps < 4) {
                ...
                if (localMadeCreeps < 2) {
                    ...
                    eval(createString);
                } else if (controllerLevel > 1 && localMadePureHarvesters < 1) {
                    var memory = "{role: 'pureHarvester', working: false, origination: '" + roomName + "'}";
                    var constructorString = "creepTemplates.creepConstructor(roomName, freeSpawn.name, creepTemplates.lev" + controllerLevel1to3 + "(\"pureHarvester\"), memory)";
                    var createString = eval(constructorString);
                    eval(createString);
                    ...
                    var createString = eval(constructorString);
                    eval(createString);
                } else if (controllerLevel > 1 && localMadeCouriers < 4) {
                    ...
                    var createString = eval(constructorString);
                    eval(createString);
                } else if (controllerLevel > 1 && localMadeExausters < 0) {
                    ...
                    var createString = eval(constructorString);
                    eval(createString);
                } else if (controllerLevel > 1 && localMadeOuterCourierLogic1 < 1) {
                    ...
                    var createString = eval(constructorString);
                    eval(createString);
                } else if (controllerLevel > 2 && localMadeOuterReserver1 < 1) {
